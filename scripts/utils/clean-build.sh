...
rm -rf $BUILDDIRNAME
cmake -B $BUILDDIRNAME -S $PROJROOT -DWITH_UNITTESTS=$UNITTESTS -DWITH_ASAN=$ASAN -DWITH_UBSAN=$UBSAN -DWITH_CPPCHECK=$CPPCHECK -DWITH_WERROR=$WERROR -DCMAKE_BUILD_TYPE:STRING=$BUILD_CONIFG
