...
mergecap -a -s 65535 -F pcap -w all.pcap all-raw.pcap all-eth.pcap all-arp.pcap all-ipv4.pcap all-ipv6.pcap all-udp.pcap all-tcp.pcap all-vrrp.pcap all-vrrp3.pcap all-stp.pcap all-rstp.pcap all-igmp.pcap