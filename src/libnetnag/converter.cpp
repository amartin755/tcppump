...
uint16_t Converter::getIPv4Chksum (const uint16_t* ipheader, int headerLen)
{
	assert (ipheader);
	assert (headerLen >= 20);
	assert (!(headerLen & 1));
