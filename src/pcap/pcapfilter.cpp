...
void cPcapFilter::unitTest ()
{
    ...
    BUG_IF_NOT (!obj.compile ("kkdkdkdk"));
    BUG_IF_NOT (obj.compile ("tcp or udp"));

    BUG_IF_NOT (obj.compile (false, false, nullptr, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (true, false, nullptr, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (false, true, nullptr, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (true, true, nullptr, nullptr, nullptr));

    BUG_IF_NOT (obj.compile (false, false, &ethers, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (false, false, nullptr, &macs, nullptr));
    BUG_IF_NOT (obj.compile (false, false, nullptr, nullptr, &ips));
    BUG_IF_NOT (obj.compile (true, false, &ethers, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (true, false, nullptr, &macs, nullptr));
    BUG_IF_NOT (obj.compile (true, false, nullptr, nullptr, &ips));
    BUG_IF_NOT (obj.compile (false, true, &ethers, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (false, true, nullptr, &macs, nullptr));
    BUG_IF_NOT (obj.compile (false, true, nullptr, nullptr, &ips));
    BUG_IF_NOT (obj.compile (true, true, &ethers, nullptr, nullptr));
    BUG_IF_NOT (obj.compile (true, true, nullptr, &macs, nullptr));
    BUG_IF_NOT (obj.compile (true, true, nullptr, nullptr, &ips));
    BUG_IF_NOT (obj.compile (true, true, &ethers, &macs, nullptr));
    BUG_IF_NOT (obj.compile (true, true, &ethers, &macs, &ips));
